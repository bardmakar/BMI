...
public class FullFoodsActivity extends AppCompatActivity {
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        setContentView(R.layout.activity_full_foods);

        listView = findViewById(R.id.listView);

        buttonGoBack = findViewById(R.id.buttonGoBack1);
        ...
        List<Food> listFromBase = fromJsonString(loadJsonString());

        String searchWord = "ка";
        String[] arr = {"srgdrg", "adsrhrh", "fefsa", "srgdrg", "adsrhrh", "srgdrg", "adsrhrh", "srgdrg", "adsrhrh", "srgdrg", "adsrhrh", "srgdrg", "adsrhrh", "srgdrg", "adsrhrh", "srgdrg", "adsrhrh", "srgdrg", "adsrhrh", "srgdrg", "adsrhrh"};
